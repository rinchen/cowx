...
Also includes At a Glance metric glyphs (`barometer`, `humidity`, `uv-index`, `thermometer-water`, `umbrella`, `raindrop`, `cloudy`) from `@meteocons/svg@3.0.0-next.10` via jsDelivr.
