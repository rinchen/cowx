/**
 * CDOT / COtrip RWIS presentation helpers (client).
 * Observations come from the keyed COtrip weatherStations feed when COTRIP_API_KEY is set.
 */

/** Hide readings older than this (clock skew / stalled station). */
